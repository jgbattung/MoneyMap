    ...
    return (
      <div className='flex flex-col max-w-5xl gap-3 bg-card border border-border rounded-md p-4 shadow-md'>
        ...
        <div className='flex items-center justify-between'>
          <Skeleton className='h-5 w-32 md:h-6 md:w-36 bg-muted' />
        ...
        <div className='flex flex-col items-start gap-1'>
          ...
          <Skeleton className='h-10 w-48 md:h-12 md:w-64 bg-muted' />
        </div>

        {/* Monthly Change Indicator Skeleton */}
        <Skeleton className='h-4 w-56 md:h-5 md:w-64 bg-muted' />

        {/* Progress Section Skeleton */}
        <div className="space-y-2 pt-2 border-t border-border">
          <div className="flex items-center justify-between">
            <Skeleton className='h-3 w-40 md:h-4 md:w-48 bg-muted' />
