...
const CardGroupPage = () => {
  ...
  if (isFetching) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-6 pb-36 md:pb-6 flex flex-col">
        {/* Header Skeleton */}
  ...
  if (error) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-6 pb-36 md:pb-6">
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-6 pb-36 md:pb-6 flex flex-col gap-6">
